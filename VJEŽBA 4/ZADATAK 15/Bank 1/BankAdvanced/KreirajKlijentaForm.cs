...
namespace BankAdvanced
{
    public partial class KreirajKlijentaForm : Form
    {
        ...
        private void privatniRadio_CheckedChanged(object sender, EventArgs e)
        {
            ...
            else if(poslovniRadio.Checked == true)
            {
                poduzeceTextBox.Enabled = true;
            }
        }

        private void KreirajKlijentaForm_Load(object sender, EventArgs e)
        {
        ...
        private void poduzeceTextBox_TextChanged(object sender, EventArgs e)
        {
